...
p7:
	cd ~/mycode/aoc/output/  && g++ ~/mycode/aoc/2015/Day4/p7.cpp ~/mycode/aoc/2015/Day4/md5.cpp  -o p7 && ./p7 | lolcat
p8:
	cd ~/mycode/aoc/output/  && g++ ~/mycode/aoc/2015/Day5/p8.cpp -o p8 && ./p8 | lolcat
p9:
	cd ~/mycode/aoc/output/  && g++ ~/mycode/aoc/2015/Day5/p9.cpp -o p9 && ./p9 | lolcat
p10:
	cd ~/mycode/aoc/output/  && g++ ~/mycode/aoc/2015/Day6/p10.cpp -o p10 && ./p10 | lolcat